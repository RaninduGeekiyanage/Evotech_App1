...
const badgeVariants = cva(
  "inline-flex items-center rounded-md border border-neutral-200 px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-neutral-950 focus:ring-offset-2 dark:border-neutral-800 dark:focus:ring-neutral-300",
  {
    variants: {
      variant: {
        default:
          "border-transparent bg-blue-600 text-neutral-50 shadow hover:bg-blue-700/80 dark:bg-neutral-50 dark:text-neutral-900 dark:hover:bg-neutral-50/80",
        secondary:
        ...
        success:
          "border-transparent bg-green-400 text-neutral-900 hover:bg-green-400/80",
      },
    },
    defaultVariants: {
      variant: "default",
